...
public class GameLogic {
    ...
    public void placeMove(int row, int col, String move) {
        if (isValidMove(row, col)) {
            ...
            board.setBoardState(boardState);  // Make sure boardState in board is updated as well.  ***important, can't find a way to automatically sychronize boardState, so this will do***
            System.out.println(Arrays.deepToString(game.getBoard().getBoardState())); // Print boardState in terminal
        }
    }
