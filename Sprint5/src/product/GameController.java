...
public class GameController {
    ...
    public void setReplayProgress(boolean inProgress) {
        ...
        //Disable S and O buttons
        blueSButton.setDisable(inProgress);
        blueOButton.setDisable(inProgress);
        redSButton.setDisable(inProgress);
        redOButton.setDisable(inProgress);
    ...
    public void replayGame(ActionEvent event) {
        ...
        List<String> recordedMoves = gameRecorder.loadFromFile();

        // Set up game configuration from the recorded moves
        setUpGameConfiguration(recordedMoves);
        ...
        if (createValidGame()) {
            ...
            replayMovesWithTimeline(recordedMoves);
        }
    }
    ...
    private void replayMovesWithTimeline(List<String> recordedMoves) {
        ...
        // Set an action to occur when the timeline finishes
        timeline.setOnFinished(event -> setReplayProgress(false));
